...
# React to user input
prompt = st.text_input("Enter the file name/location")
...
with col1:
    if st.button("gdrive/FY2025/Datashapes.pdf"):
        prompt = "gdrive/FY2025/Datashapes.pdf"

# Button to suggest second input
with col2:
    if st.button("C://Documents/Application_2024.pdf"):
        prompt = r"C://Documents/Application_2024.pdf"
        ...
        if response.status_code == 200:
            ...
            if 'choices' in result:
                ...
                with st.chat_message("assistant"):
                    typewriter(text=response, speed=120)
